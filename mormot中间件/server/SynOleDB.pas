...
/// modified by cxg 2017-12-20 连接MSSQL改用SQLOLEDB
...
procedure CoUninit;
begin
//  assert(OleDBCoinitialized>0,'You should call TOleDBConnection.Free from the same '+    // by cxg
...
begin
  ...
  if fProviderName='' then
    fProviderName := 'SQLOLEDB';     // edit by cxg 
